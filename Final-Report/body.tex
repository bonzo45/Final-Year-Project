...
\subsection*{Sphere}
Two ways of mapping the uncertainty to the surfaces have been trialled. OThe first maps the uncertainty to a texture which can then be applied to a surface. 
