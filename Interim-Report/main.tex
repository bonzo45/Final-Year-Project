...
\begin{figure}[h]
    ...
    \caption{A number of different labelling techniques have been studied. From \cite{labelling}}
    \label{fig:labels}
\end{figure}

If the need for labelling comes up in my project it will be worth investigating these techniques. See Figure~\ref{fig:labels}
